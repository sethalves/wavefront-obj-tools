  ...
  (begin
    ...
    (define (main-program)
      (define (usage why)
        ...
        (display "  --bullet-hull             output hull for bullet physics\n")
         ...
         (lambda (arg)
           (case (car arg)
             ...
             ((--hull)
              ...
              (if bullet-hull (usage "don't use both --bullet-hull and --hull"))
              (set! convex-hull #t))
             ((--bullet-hull)
              (if bullet-hull (usage "give --bullet-hull only once"))
              (if convex-hull (usage "don't use both --bullet-hull and --hull"))
              (set! bullet-hull #t))
             ((-C)
        ...
        (let* ((model (make-empty-model))
          ...
          (let loop ((input-files input-files))
            (cond ((null? input-files)
                   ...
                   (cond (bullet-hull
                          (compact-obj-model model)
                          (set! model (model->bullet-hull model))))
